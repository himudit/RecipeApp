...
function Cards({ id, recipe, name, img_src }) {
    ...
    return (
        // <div className="relative m-2 p-4 rounded-3xl flex flex-col items-center  w-full sm:w-1/2 md:w-1/3 lg:w-1/4 max-w-xs text-white">
        <div
            className={`relative m-2 p-4 rounded-3xl flex flex-col items-center w-full sm:w-1/2 md:w-1/3 lg:w-1/4 max-w-xs text-white ${toggle ? 'bg-gray-700' : 'bg-white'
                }`}
        >
            <img
                src={img_src}
